...
*   **Feature: Ship Visualization (Player & AI) (F03)**
    ...
    *   US04: As a user, I want to see my ship represented on the map, so that I know my position.
        ...
        *   [ ] Task 4.1: Create a `ShipService` class/module in `app.js`.
            *   [ ] Implement a `createShip(coordinates, isPlayer)` method.
                *   [ ] Create an OpenLayers feature representing the ship.
                *   [ ] Use a simple vector style (triangle, circle).
                *   [ ] Differentiate the player ship visually (e.g., different color).
            *   [ ] Implement a `moveShip(shipFeature, coordinates)` method.
            *   [ ] Implement a method to add ship features to a Vector layer.
        *   [ ] Task 4.2: Create Vector layer to host ships.
        *   [ ] Task 4.3: Add the player ship to the map at a default starting location.
            *   [ ] Use `ShipService.createShip()` and `ShipService.addShipToMap()`.
            *   [ ] Set the `isPlayer` flag to `true`.
        *   [ ] Task 4.4: Ensure the ship remains within the map bounds.
